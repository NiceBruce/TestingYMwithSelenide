...
/**
 *   Данный класс расширяет функциональность для работы с отчётами в Allure Framework в Selenide
 *   Реализовано снятие скриншотов на любое взаимодействие с веб-страницей
 *   (решение заимствовано из лекции)
 *   @author Борис Демин
 */
